...
**BMAD** (Breakthrough Method for Agile AI Driven Development) is an AI-driven agile development methodology based on ApiHug specifications, implementing automated generation from requirements to code through **Agents** (intelligent agents) and **Workflows** (workflows).
