export const title = "011 Api Test";
export const description =
  "how to test api in ApiHug Api design Copilot.";
...
<img src="/img/plugin/109_test_01.gif" alt="ApiHug Test Manager" width={2334} height={1768} className="rounded-lg" />
...
<img src="/img/plugin/109_test_02_script.gif" alt="ApiHug Test Script Manager" width={2334} height={1768} className="rounded-lg" />
...
<img src="/img/plugin/109_test_03_env.gif" alt="ApiHug Test Environment Manager" width={2334} height={1768} className="rounded-lg" />
