export const title = "004 Service Design and Debug Panel";
...
<img src="/img/plugin/102_service.gif" alt="ApiHug Service Manager" width={2334} height={1768} className="rounded-lg" />
