...
<img src="/img/plugin/protobuf_plugin.png" alt="ApiHug plugin" width={986} height={712} className="rounded-lg" />
...
<img src="/img/plugin/import_error.png" alt="ApiHug plugin SDK import error" width={880} height={361} className="rounded-lg" />

**01: Compile the project** (via markdown or gradle task)

<img src="/img/plugin/2ways_build.png" alt="ApiHug 2 ways build project" width={1113} height={568} className="rounded-lg" />
...
<img src="/img/plugin/2ways_build_success.png" alt="ApiHug success build" width={1202} height={535} className="rounded-lg" />
...
<img src="/img/plugin/2ways_finally.png" alt="ApiHug import finally" width={1928} height={1041} className="rounded-lg" />
...
<img src="/img/plugin/gradle_loader.png" alt="ApiHug Load gradle project" width={740} height={428} className="rounded-lg" />
...
<img src="/img/plugin/api-tree-rebuild.png" alt="ApiHug Rebuild" width={678} height={518} className="rounded-lg" />
...
<img src="/img/plugin/version_checker.png" alt="ApiHug version check" width={1248} height={545} className="rounded-lg" />
