export const title = "008 Error Design";
export const description =
  "how to use the error design panel of ApiHug Api design Copilot.";
...
<img src="/img/plugin/106_errors.gif" alt="ApiHug Errors Manager" width={2334} height={1768} className="rounded-lg" />
