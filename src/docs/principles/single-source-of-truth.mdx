...
<img src="/img/principles/git-op1.webp" alt="GitOps as a control layer for versioned assets" width={1080} height={758} className="rounded-lg" />
...
<img src="/img/principles/api-syn-2.webp" alt="Specification acting as a neutral collaboration layer" width={1080} height={390} className="rounded-lg" />
