export const title = "ApiHug 2.0 LLM Optimization Specification";
...
plugins {
    ...
    // Remove the Liquibase plugin—it was never actively used and now causes dependency conflicts
}
...
ApiHug defines four active specifications based on Protocol Buffers extension capabilities, plus one legacy compatibility specification for older projects:
...
| **Mock Data Specification**          | Mock rules for test data     | [View Details](/docs/spec/mock)     |
| **Version Change Specification**     | Legacy version annotations   | [View Details](/docs/spec/version)  |
...
4. [Mock Data Specification](/docs/spec/mock)
