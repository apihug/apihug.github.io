...
4. run `wire`, `stub`, and the application
...
`stub` generates the application-side scaffolding from the contract module.

1. Open `README.md > 2. Build Stub (Individual)`
2. Run the command, for example `gradlew.bat demo-app:clean stub build -x test -x stubTest`
3. Review the generated output under `demo-app`

<img src="/img/editor/007_stub.gif" alt="ApiHug Stub Project" width={2316} height={1768} className="rounded-lg" />
