...
<TipGood>
  Since 3.0.0+ Version, only support spring boot 4.0+
</TipGood>

## One-Click Initialization

Transform an empty directory into an Apihug workspace with a single command.  
The script automatically downloads and runs the Apihug installer for your platform.
...
### Spring 4.0 Migration

**SDK 3.0** is still undergoing rapid upgrades and constant updates, with many compatibility issues yet to be discovered. How to upgrade Spring to 4.0. Note [Spring Boot 4.0 Migration Guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide)

## Prerequisites

1. ✅ JDK 17+  [OpenJDK](https://openjdk.org/) or Oracle's
2. ✅ [Gradle](https://gradle.org/install/) 8+
3. ✅ [IDEA](https://www.jetbrains.com/idea/)  2022+ (Optional)
...
⚠️ The IDEA plugin will no longer be upgraded frequently in the future, IDEA support is no longer the main direction, you can use Apihug REPL for most things!
