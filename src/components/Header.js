...
function Featured() {
  return (
    <a
      ...
      className="ml-3 text-xs leading-5 font-medium text-sky-600 dark:text-sky-400 bg-sky-400/10 rounded-full py-1 px-3 hidden xl:flex items-center hover:bg-sky-400/20"
    >
      <strong className="font-semibold">SDK v1.4.5 + Plugin 0.7.7</strong>
      <svg
        width="2"
        height="2"
        fill="currentColor"
...
export function NavItems() {
  return (
    <>
      ...
      <li>
        <Link href="/docs/kola" className="hover:text-sky-500 dark:hover:text-sky-400" title={'Api Test'}>
          Kola
        </Link>
      </li>
      <li>
        <Link href="https://apihug.github.io" className="hover:text-sky-500 dark:hover:text-sky-400" title={'Permanent Homepage'}>
          Home
        </Link>
      </li>
    </>
