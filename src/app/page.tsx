...
import EnterpriseFactorySection from "@/components/home/enterprise-factory-section";
import AgentVisionSection from "@/components/home/agent-vision-section";
import BlueprintSection from "@/components/home/blueprint-section";
import ProtoSemanticSection from "@/components/home/proto-semantic-section";
import EntityDesignSection from "@/components/home/entity-design-section";
    ...
    <div className="max-w-screen overflow-x-hidden">
      ...
      <div className="grid min-h-dvh grid-cols-1 grid-rows-[1fr_1px_auto_1px_auto] justify-center pt-14.25 [--gutter-width:2.5rem] md:-mx-4 md:grid-cols-[var(--gutter-width)_minmax(0,var(--breakpoint-2xl))_var(--gutter-width)] lg:mx-0">
        ...
        <div className="grid gap-24 pb-24 text-gray-950 sm:gap-40 md:pb-40 dark:text-white">
          <Hero />
          <BlueprintSection />
          <ProtoSemanticSection />
          <EntityDesignSection />
          <EnterpriseFactorySection />
          <AgentVisionSection />
        </div>
