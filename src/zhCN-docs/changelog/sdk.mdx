export const title = "SDK Changelog";
...
## [2.1.4-RELEASE] - 2026-01-05

- **Simplified Code Generation Workflow**: ONLY use the `wire` command to streamline generated code management. Running `wire` now automatically moves all generated artifacts into the `generated/` directory, reducing manual overhead and ensuring consistent output placement.
- **Bug Fixes**: Addressed issues affecting code generation reliability and output handling.


## [2.1.3-RELEASE] - 2026-01-05

- `api.index.csv` missed the table part index
- upgrade the proto-generate prompt
- Bug fix




## [2.1.2-RELEASE] - 2026-01-03

- Enhance REPL, Support BMAD
- introduce it-hope(plugin) consolidate plugin(wire+stub)
- Bug fix


## [2.0.5-RELEASE] - 2025-12-22

- Enhance REPL
- Bug fix


## [2.0.3-RELEASE] - 2025-12-19

- Enhance REPL
- Bug fix

## [2.0.2-RELEASE] - 2025-12-17

- Add REPL support
- Bug fix

## [2.0.0-RELEASE] - 2025-12-10
...
- Keep the customized `tenantId`, `updatedBy` if passed by caller instead of pick from context.
- Bug fix
...
## [1.4.2-RELEASE] - 2025-07-25

- Update the way of control context and contract adapter.
- Bug fix


## [1.4.0-RELEASE] - 2025-06-13

- Add support for enterprise-level MCP, leveraging existing infrastructure and authorization protection.
- Bug fix
...
## [1.3.8-RELEASE] - 2025-05-15

- toml version control standard
- Bug fix


## [1.3.7-RELEASE] - 2025-05-14

- process for path parameters path
- Bug fix


## [1.3.6-RELEASE] - 2025-05-10

- add i18n support for authority
- Bug fix


## [1.3.5-RELEASE] - 2025-05-02

- page title logic update and i18n `pages.json`
- Bug fix

## [1.3.4-RELEASE] - 2025-05-01

- update the ui configuration name standard
- Bug fix


## [1.3.3-RELEASE] - 2025-04-29

- enhance the vue logic
- Bug fix


## [1.3.0-RELEASE] - 2025-04-27
...
## [1.2.9-RELEASE] - 2025-04-25

- Runtime Meta information loader add `Authorty`
- Consolidate runtime all meta: Error, Dictionary, Authority picker
- Bug fix


## [1.2.8-RELEASE] - 2025-04-22

- Enhance for the code generate
- Bug fix


## [1.2.7-RELEASE] - 2025-04-22

- Vue generator extract the authorities to static `Permission` information
- Bug fix

## [1.2.6-RELEASE] - 2025-04-21

- Add MCP meta information support
- Bug fix

## [1.2.2-RELEASE] - 2025-04-12

- candidate version for the front-end code generated milestone release
- regular validation rule code translate bug
- Bug fix

## [1.2.1-RELEASE] - 2025-04-02

- add `// @formatter:off` for generated code avoid the auto code formatter
- more meta information: `versions`, and api get by version(passed through parameters:`version=?`)
- Bug fix


## [1.1.9-RELEASE] - 2025-03-21

- Remove deprecated API
dependencies [Removal of deprecated API of Spring Data ](https://github.com/spring-projects/spring-data-commons/wiki/Spring-Data-2024.1-Release-Notes#spring-data-relational---34);
- Bug fix
...
1. Optimize the process of the `Enum` in Hope [如何处理Enum](/zhCN-docs/how/003_how_to_handle_enum)
2. Bug fix
...
1. [api lint](/docs/tool/apihug-lint) 设计
2. api lint 优化
3. Bug fix
...
2. 在 `wire` proto 过程中引入了新的 `kolaTest` 任务
