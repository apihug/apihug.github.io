...
**SDK 3.0** 现在还在快速升级中，保持更新，大量的兼容性问题有待发现， 如何升级spring 到 4.0 注意 [Spring Boot 4.0 Migration Guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide)
...
⚠️ IDEA plugin 后续将不再频繁升级， IDEA 支持已不是主要方向，你可以用 Apihug REPL 做绝大部分事情！
