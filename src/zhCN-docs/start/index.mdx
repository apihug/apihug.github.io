...
这一页带你从空目录走到一个可运行的 ApiHug 演示项目。路径很直接：先准备环境，再生成项目，接着跑通 `wire`、`stub` 和应用启动，最后检查生成出的 OAS 接口文档。

<TipGood>
  ApiHug 3.x 面向 Spring Boot 4.0 及以上版本。升级老项目前，建议先阅读 Spring Boot 4.0 迁移指南。
</TipGood>
...
<img src={require('@/img/editor/001_install_plugin.gif').default.src} alt="安装 ApiHug 插件" width={2316} height={1768} className="rounded-lg" />
...
<img src={require('@/img/editor/005_load_project.gif').default.src} alt="ApiHug 加载项目" width={2316} height={1768} className="rounded-lg" />
...
<img src={require('@/img/editor/006_wire.gif').default.src} alt="ApiHug Wire 项目" width={2316} height={1768} className="rounded-lg" />
...
<img src={require('@/img/editor/007_stub.gif').default.src} alt="ApiHug Stub 项目" width={2316} height={1768} className="rounded-lg" />
...
<img src={require('@/img/editor/008_boot.gif').default.src} alt="ApiHug Spring Boot" width={2316} height={1768} className="rounded-lg" />
...
<img src={require('@/img/editor/009_OAS.gif').default.src} alt="ApiHug API 信息" width={2316} height={1768} className="rounded-lg" />
