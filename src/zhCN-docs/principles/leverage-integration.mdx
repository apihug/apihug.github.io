export const title = "Integration and symbiosis, maximizing value";
export const description =
  "Why is it important to maximize the use of existing resources and inputs? For developers and companies, maximizing the use of existing resources and inputs is very important.";
