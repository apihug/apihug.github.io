...
<img src="/img/principles/git-op1.webp" alt="GitOps 作为版本化资产的控制层" width={1080} height={758} className="rounded-lg" />
...
<img src="/img/principles/api-syn-2.webp" alt="规范作为中立协作层" width={1080} height={390} className="rounded-lg" />
